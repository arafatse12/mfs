    ...
    <div class="content container-fluid">
        ...
        <ul class="nav nav-tabs menu-tabs">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url() . 'admin/stripe-payment-gateway'; ?>">Payment Gateway</a>
            </li>
            <li class="nav-item">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
							...
							<ul class="nav nav-tabs menu-tabs">
								...
								<li class="nav-item active">
									<a class="nav-link" href="<?php echo base_url() . 'admin/paytabs-payment-gateway'; ?>">PayTabs</a>
								</li>
							</ul>
...
<?php } ?>
                                ...
                                <a href="<?php echo base_url() . 'admin/paypal-payment-gateway' ?>" class="btn btn-cancel m-l-5">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
