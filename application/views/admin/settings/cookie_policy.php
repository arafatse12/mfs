		...
		<div class="row">
			<div class="col-xl-8 offset-xl-2">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h3 class="page-title"><?php echo(!empty($admin_settings['lg_admin_cookie_policy']))?($admin_settings['lg_admin_cookie_policy']) : 'Cookie Policy';  ?></h3>
						</div>
					</div>
				</div>
				<!-- /Page Header -->
					...
					<div class="card-body">
						...
						<?php 
							if (!empty($cookie_policy)) {
								foreach ($cookie_policy as $cookie) { 
						?>	
						<?php foreach ($lang_test as $langval) {
								if($langval->language_value ==  $cookie['lang_type']) {?>
							<div class="form-group">
                                ...
                                <input type="text" class="form-control" name="page_title_<?php echo $langval->id; ?>" value="<?php echo ($cookie['title'])?$cookie['title']:''; ?>" required>
	                        </div>
	                    <?php } } } }?>
	                        <div class="form-group">
						...
						<?php foreach ($lang_test as $langval) {
							...
							<div class="form-group">
							    ...
							    <textarea class='form-control content-textarea' id='ck_editor_textarea_id2' rows='6' name='page_content_<?php echo $langval->id; ?>' required><?php echo ($cookie['content']) ? $cookie['content']:''; ?></textarea>
