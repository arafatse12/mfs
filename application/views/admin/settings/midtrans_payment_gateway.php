<div class="page-wrapper">
    <div class="content container-fluid">
		...
		<ul class="nav nav-tabs menu-tabs">
			...
			<li class="nav-item ">
				<a class="nav-link" href="<?php echo base_url() . 'admin/paystack-payment-gateway'; ?>">Paystack</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url() . 'admin/paysolution-payment-gateway'; ?>">Paysolution</a>
			</li>
			<li class="nav-item">
					...
					<div class="card">
						...
						<div class="card-body">
                            ...
                            <div class="mt-4">
								...
								<?php } ?>
                                <a href="<?php echo base_url() . 'admin/midtrans-payment-gateway' ?>" class="btn btn-cancel m-l-5">Cancel</a>
                            </div>
						</div>
					</div>
				</form>
