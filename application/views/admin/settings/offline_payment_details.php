                                   ...
                                   foreach ($list as $rows) 
                                    {
                                    	...
                                    	$paid_status = $this->db->select('paid_status')->get_where('subscription_details', array('id'=>$rows['sub_id']))->row_array();
                                    	 $badge='';
                                    	 $disabled= '';
									...
									$date=date(settingValue('date_format'), strtotime($rows['expiry_date_time'])); 
										...
										echo '<td><select class="form-control refundstatus" name="ser_status" data-id="'.$rows['sub_id'].'" data-userid="'.$rows['subscriber_id'].'" data-detail-id="'.$rows['subscription_details_id'].'"'.$disabled.'> 
