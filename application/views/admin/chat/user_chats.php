                        ...
                        <div class="col-md-8 col-xl-8 chat d-flex chat-scroll">
                            ...
                            <div class="card w-100 mb-0" id="history_page">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="input-group">
                                        <input name="" class="form-control type_msg mh-auto empty_check" id="chat-message" placeholder="<?php echo(!empty($chat['lg_admin_type_your_message']))?($chat['lg_admin_type_your_message']) : 'Type your message...';  ?>" maxlength="1000"></input>
