...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title"><?php echo(!empty($chat['lg_admin_chat_list']))?($chat['lg_admin_chat_list']) : 'Chat List';  ?></h3>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                    ...
                    <div class="card-header">
                        <form class="chat-search">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="<?php echo(!empty($chat['lg_admin_search']))?($chat['lg_admin_search']) : 'Search';  ?>" name="search_chat_list" id="search_chat_list" class="form-control search-chat ">
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-md-8 chat d-flex chat-scroll">
                ...
                <div class="card w-100 mb-0" id="history_page">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="user_info">
                                ...
                                <p class="mb-0"><?php echo(!empty($chat['lg_admin_messages']))?($chat['lg_admin_messages']) : 'Messages';  ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="input-group">
                            <input name="" class="form-control type_msg mh-auto empty_check" id="chat-message" placeholder="<?php echo(!empty($chat['lg_admin_type_your_message']))?($chat['lg_admin_type_your_message']) : 'Type your message...';  ?>" maxlength="1000">
