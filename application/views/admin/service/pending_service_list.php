...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col">
					<h3 class="page-title"><?php echo(!empty($service_list['lg_admin_pending_service']))?($service_list['lg_admin_pending_service']) : 'Pending Service';  ?></h3>
				</div>
							...
							<table class="table table-hover table-center mb-0 service_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo(!empty($service_list['lg_status']))?($service_list['lg_status']) : 'Status';  ?></th>
                                ...
                                <tbody>
									...
									echo'<tr>
										...
										<td> 
											<a href="'.base_url().'pending-service-details/'.$rows['id'].'" class="btn btn-sm bg-info-light">
