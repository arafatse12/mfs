							...
							<div class="card-body">
								...
								<div class="sp-plan-name">
									<h6 class="title">
					                    ...
					                    $this->db->where('sub_id', $subscription_name['id']);
					                    $this->db->where('lang_type', $sub_lang);
					                    $sub_name = $this->db->get('subscription_lang')->row_array();
										if(!empty($sub_name['subscription_name'])){ ?>
										<?php echo $sub_name['subscription_name'];?> <span class="badge badge-success badge-pill">Active</span>
									<?php }else{?>
