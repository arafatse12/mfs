                    ...
                    <div class="row">
                        <div class="col-lg-6">
						    <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="service_location" <?php if(settingValue('location_type') == 'live') { ?> id="service_location" <?php } else { ?> id="service_locations" <?php } ?>required>
                                <input type="hidden" class="form-control" id="map_key" value="<?php echo settingValue('map_key'); ?>" >
                                <input type="hidden" class="form-control" id="service_location_types" value="<?php echo settingValue('location_type'); ?>" >
