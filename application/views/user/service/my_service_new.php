                ...
                <div class="row" id="dataList">
                    ...
                    if (!empty($services)) {
                        foreach ($services as $srows) {
                            ...
                            $service_availability = $this->db->where('service_id', $srows['id'])->where('status!=', 6)->where('status!=', 7)->where('status!=', 8)->where('status!=', 10)->from('book_service')->count_all_results();
