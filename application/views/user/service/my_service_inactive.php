                ...
                <div class="row" id="dataList">
                    ...
                    if (!empty($services)) {
                        foreach ($services as $srows) {
                            ...
                            <div class="col-lg-4 col-md-6 inactive-service contant">
                                <div class="service-widget">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="cate-list">
                                                 <?php  
                                                    ...
                                                    $check_cat_names = $this->db->get('categories_lang')->row_array();
                                                    $this->db->where('category_id', $check_cat_names['category_id']);
                                                    $this->db->where('lang_type', $cat_lang);
                                                    $cat_names = $this->db->get('categories_lang')->row_array();
                                                ?>
                                                <a class="bg-yellow" href="<?php echo base_url() . 'search/' . str_replace(' ', '-', strtolower($srows['category_name'])); ?>"><?php echo $cat_names['category_name']; ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="service-content">
                                        <h3 class="title">
                                            ...
                                            ?>
                                            <a href="<?php echo base_url() . 'service-preview/' . $srows['url']; ?>"><?php echo $service_name['service_name']; ?></a>
                                        </h3>
                                        <div class="rating">
                                        ...
                                        <div class="user-info">
                                            ...
                                            <div class="service-action">
                                                <div class="row">
                                                    <div class="col"><a href="javascript:void(0)" class="si-delete-inactive-service text-danger" data-id="<?php echo $srows['id']; ?>"><i class="far fa-trash-alt"></i> <?php echo (!empty($user_language[$user_selected]['lg_Delete'])) ? $user_language[$user_selected]['lg_Delete'] : $default_language['en']['lg_Delete']; ?></a></div>
                                                    <?php if($srows['admin_verification'] == 1) { ?>
                                                        <div class="col text-right"><a href="javascript:void(0)" class="si-delete-active-service text-success" data-id="<?php echo $srows['id']; ?>"><i class="fas fa-info-circle"></i> <?php echo (!empty($user_language[$user_selected]['lg_active'])) ? $user_language[$user_selected]['lg_active'] : 'Active'; ?></a></div>
                                                    <?php }?>
                                                </div>
                                            </div>
                                        </div>											
                        ...
                        $no_service = (!empty($user_language[$user_selected]['lg_no_service'])) ? $user_language[$user_selected]['lg_no_service'] : $default_language['en']['lg_no_service'];
                        echo '<div class="col-xl-12 col-lg-12">'.$no_service.'</div>';
                    }
                    ?>
...
<div class="modal fade" id="deleteNotConfirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="acc_msg">Service is Booked or Inprogress..</p>
            </div>
            <div class="modal-footer">
