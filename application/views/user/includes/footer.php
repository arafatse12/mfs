						...
						<div class="login-right">
							...
							<form method='post' id="new_third_page_user">
								...
								<div class="form-group">
									...
									<input type="hidden" class="form-control" name="userLogintype" id='user_logintype2' value="<?=$login_type?>" >
								</div>
								<div class="form-group">
									<label><?php echo (!empty($user_language[$user_selected]['lg_password'])) ? $user_language[$user_selected]['lg_password'] : $default_language['en']['lg_password']; ?></label>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
						...
						<div class="login-right">
							...
							<form method='post' id="forgetpwddiv">
								<div class="form-group">
									...
									<input type="hidden" class="form-control" name="userLogintype" id='user_logintype1' value="<?=$login_type?>" >
			...
			<div class="modal-body step-2" data-step="2">
				...
				<form action="<?php echo base_url()?>user/login/send_otp_request_user" method='post' id="new_fourth_page_user1">
					<div class="form-group">
					...
					<div class="form-group">						
						...
						<?php } ?>
						<input type="text" class="form-control form-control-lg no_only" autocomplete="off" maxlength="4" minlength="4" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_enter_otp_here'])) ? $user_language[$user_selected]['lg_enter_otp_here'] : $default_language['en']['lg_enter_otp_here']; ?>" name="otp_number" id='otp_number_user1'>
						<span for='otp_number' id='otp_error_msg'></span>
					</div>
					
					<p class="resend-otp"><?php echo (!empty($user_language[$user_selected]['lg_Didnt_receive_the_OTP'])) ? $user_language[$user_selected]['lg_Didnt_receive_the_OTP'] : $default_language['en']['lg_Didnt_receive_the_OTP']; ?> <a href="#" id="re_send_otp_user"> <?php echo (!empty($user_language[$user_selected]['lg_Resend_OTP'])) ? $user_language[$user_selected]['lg_Resend_OTP'] : $default_language['en']['lg_Resend_OTP']; ?></a></p>
					<div>
						<button id='registration_final1' type="submit" class="login-btn" ><?php echo (!empty($user_language[$user_selected]['lg_enter'])) ? $user_language[$user_selected]['lg_enter'] : $default_language['en']['lg_enter']; ?></button>
					</div>
					<div>
						<button id='registration_resend1' type="button" class="invisible login-btn" ><?php echo (!empty($user_language[$user_selected]['lg_Resend'])) ? $user_language[$user_selected]['lg_Resend'] : $default_language['en']['lg_Resend']; ?></button>
					</div>
				</form> 
			</div>
		</div>
				...
				<?php if($categories->widget_showhide == 1 && !empty($result)) { ?>
						<div class="col-lg-3 col-md-6">
							<div class="footer-widget footer-menu">
								<?php 
			                        foreach ($cat_wid_language as $cat_wid) { ?>
			    						<h2 class="footer-title"><?php echo(!empty($cat_wid['title']))?($cat_wid['title']) : 'Category Widget';  ?></h2>
		                        ...
		                        <div class="about">
		                            <div class="contactdet">
										...
										<?php foreach ($result as $res) { 
											...
											$this->db->where('category_id', $res['id']);
								            $this->db->where('lang_type', $cat_lang);
								            $cat_name = $this->db->get('categories_lang')->row();
											
											?>

											<li><a href="<?php echo base_url(); ?>search/<?php echo str_replace(' ', '-', strtolower(($res['category_name']))); ?>">
											<?php echo $res['category_name']?></a></li>
								...
								<div class="about">
		                            <div class="contactdet">
										...
										<?php } } foreach ($quick_name as $quick) { ?>
											<li><a href="<?php echo $base_url; ?>pages_details/<?php echo $quick['slug']; ?>"><?php echo $quick['title']; ?></a></li>
										<?php }?>
										</ul>
		                            </div>
		                        </div>
							...
							<div class="footer-widget footer-menu">
								<?php 
			                        foreach ($con_wid_language as $con_wid) { ?>
			    						<h2 class="footer-title"><?php echo(!empty($con_wid['title']))?($con_wid['title']) : 'Contact Widget';  ?></h2>
		                                ...
		                                <ul>
											<li class="color-grey"><div class="footer-contact-info">
												<div class="footer-address">
													...
													<p class="mb-0"><i class="fas fa-envelope"></i> <?php echo $contact_us->email; ?></p>
												</div>
											</li>
										</ul>
		                            </div>
							...
							<div class="footer-widget footer-menu">	
								<?php 
			                        foreach ($soc_wid_language as $soc_wid) { ?>
			    						<h2 class="footer-title"><?php echo(!empty($soc_wid['title']))?($soc_wid['title']) : 'Contact Widget';  ?></h2>
										...
										<?php 
											...
											foreach ($followUs as $key => $value) { 
												if(!empty($value)) {
													if ($key == 'facebook') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook-f"></i></a></li>
													<?php 	
													}
													if ($key == 'twitter') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-twitter"></i></a></li>
													<?php 	
													}
													if ($key == 'youtube') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-youtube"></i></a></li>
													<?php 	
													}
													if ($key == 'linkedin') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-linkedin"></i></a></li>
											
													<?php 	
													}
													if ($key == 'github') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-github"></i></a></li>
													<?php 	
													}
													if ($key == 'instagram') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram"></i></a></li>
													<?php 	
													}
													if ($key == 'gplus') {
														?>
											<li><a href="<?php echo $value; ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-google"></i></a></li>
													<?php 	
													}
												?>
										<?php } } ?>
...
<?php } ?>
		...
		<div id="cancelModal" class="modal fade" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title"><?php echo (!empty($user_language[$user_selected]['lg_cancelation_reason'])) ? $user_language[$user_selected]['lg_cancelation_reason'] : $default_language['en']['lg_cancelation_reason']; ?></h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
