            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control" required>
						...
						{
							$review_lang = ($this->session->userdata('user_select_language'))?$this->session->userdata('user_select_language'):'en';
							$this->db->where('rating_id', $type['id']);
						    $this->db->where('lang_type', $review_lang);
						    $lang_rating = $this->db->get('rating_type_lang')->row_array();
							?>
                        <option value="<?=$type['id']?>"><?php echo $lang_rating['rating_name'];?></option>
                        <?php } ?>
                    </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-theme py-2 px-4 text-white mx-auto"
                        id="blockingProvider"><?php echo (!empty($user_language[$user_selected]['lg_Submit'])) ? $user_language[$user_selected]['lg_Submit'] : $default_language['en']['lg_Submit']; ?></button>
                    <?php }else{?>
                    <button type="button" class="btn btn-theme py-2 px-4 text-white mx-auto"
                        id="blockingUser"><?php echo (!empty($user_language[$user_selected]['lg_Submit'])) ? $user_language[$user_selected]['lg_Submit'] : $default_language['en']['lg_Submit']; ?></button>
                    <?php }?>
                </div>
            </div>
        </div>
...
<div class="modal" id="account_alert">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <p><?php echo (!empty($user_language[$user_selected]['lg_Please_Enter_Profile_informations'])) ? $user_language[$user_selected]['lg_Please_Enter_Profile_informations'] : $default_language['en']['lg_Please_Enter_Profile_informations']; ?>
                    </p>
...
<div class="modal" id="account_alert_provider">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <p><?php echo (!empty($user_language[$user_selected]['lg_Please_Fill_Account_Informations'])) ? $user_language[$user_selected]['lg_Please_Fill_Account_Informations'] : $default_language['en']['lg_Please_Fill_Account_Informations']; ?>
                    </p>
                    <button type="button"
...
<div class="modal" id="account_alert_provider_sub">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <p><?php echo (!empty($user_language[$user_selected]['lg_Please_Subscripe'])) ? $user_language[$user_selected]['lg_Please_Subscripe'] : $default_language['en']['lg_Please_Subscripe']; ?>
                    </p>
                    <button type="button"
                        class="btn btn-primary go_provider_availability"><?php echo (!empty($user_language[$user_selected]['lg_Ok'])) ? $user_language[$user_selected]['lg_Ok'] : $default_language['en']['lg_Ok']; ?></button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <p><?php echo (!empty($user_language[$user_selected]['lg_Please_Fill_Availability'])) ? $user_language[$user_selected]['lg_Please_Fill_Availability'] : $default_language['en']['lg_Please_Fill_Availability']; ?>
                    </p>
...
<form class="modal account-modal fade multi-step modal-scroll" id="modal-wizard" data-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="account-box">
                        <div class="login-right">
                            <div class="login-header">
                                <h3><?php echo (!empty($user_language[$user_selected]['lg_Join_Professional'])) ? $user_language[$user_selected]['lg_Join_Professional'] : $default_language['en']['lg_Join_Professional']; ?>
                                </h3>
                                <p class="text-muted">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-control-xs custom-checkbox">
                                    ...
                                    <label class="custom-control-label"
                                        for="agree_checkbox"><?php echo (!empty($user_language[$user_selected]['lg_agree'])) ? $user_language[$user_selected]['lg_agree'] : $default_language['en']['lg_agree']; ?>
                                        <?=$lang_website_check['cookie_name']?></label> <a tabindex="-1"
                                        href="<?php echo base_url();?>privacy"><?php echo (!empty($user_language[$user_selected]['lg_Privacy_Policy'])) ? $user_language[$user_selected]['lg_Privacy_Policy'] : $default_language['en']['lg_Privacy_Policy']; ?></a>
                                    &amp; <a tabindex="-1" href="<?php echo base_url();?>terms-conditions">
                                        <?php echo (!empty($user_language[$user_selected]['lg_Terms'])) ? $user_language[$user_selected]['lg_Terms'] : $default_language['en']['lg_Terms']; ?>.</a>
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-body step-4" data-step="4">
                <div class="login-header">
                    <h3><?php echo (!empty($user_language[$user_selected]['lg_otp'])) ? $user_language[$user_selected]['lg_otp'] : $default_language['en']['lg_otp']; ?>
                    </h3>
                    <p class="text-muted">
                ...
                <form action="<?php echo base_url()?>user/login/send_otp_request" method='post' id="new_fourth_page">
                    ...
                    <div class="alert alert-success text-center" role="alert">
                        ...
                        <strong><?php echo (!empty($user_language[$user_selected]['lg_Registration_Provider'])) ? $user_language[$user_selected]['lg_Registration_Provider'] : $default_language['en']['lg_Registration_Provider']; ?>
                        </strong>
                        <strong><?php echo (!empty($user_language[$user_selected]['lg_Please_Check_Your_Registered_Mobile'])) ? $user_language[$user_selected]['lg_Please_Check_Your_Registered_Mobile'] : $default_language['en']['lg_Please_Check_Your_Registered_Mobile']; ?>
                        </strong>
                    </div>
                    <?php } else {?>
                    <div class="alert alert-danger text-center" role="alert">
                        ...
                        <strong><?php echo (!empty($user_language[$user_selected]['lg_default_otp'])) ? $user_language[$user_selected]['lg_default_otp'] : $default_language['en']['lg_default_otp']; ?></strong>
                    </div>
                    <?php }?>
                    <div class="form-group">
                    ...
                    <p class="resend-otp">
                        ...
                        <a href="#" id="re_send_otp_provider">
                            <?php echo (!empty($user_language[$user_selected]['lg_Resend_OTP'])) ? $user_language[$user_selected]['lg_Resend_OTP'] : $default_language['en']['lg_Resend_OTP']; ?></a>
                    </p>
                    <?php }?>
                    <div>
...
<div class="modal account-modal fade multi-step modal-scroll" id="modal-wizard1" data-keyboard="false"
    data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header p-0 border-0">
                        ...
                        <div class="login-right">
                            ...
                            <form method='post' id="new_third_page_user">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="userLogintype" id='user_logintype2'
                                        value="<?=$login_type?>">
                                </div>
                                <div class="form-group">
                                    <label><?php echo (!empty($user_language[$user_selected]['lg_password'])) ? $user_language[$user_selected]['lg_password'] : $default_language['en']['lg_password']; ?></label>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-control-xs custom-checkbox">
                                        ...
                                        <label class="custom-control-label"
                                            for="agree_checkbox_user"><?php echo (!empty($user_language[$user_selected]['lg_agree'])) ? $user_language[$user_selected]['lg_agree'] : $default_language['en']['lg_agree']; ?>
                                            <?=$lang_website_check['cookie_name']?></label> <a tabindex="-1"
                                            href="<?php echo base_url();?>privacy"><?php echo (!empty($user_language[$user_selected]['lg_Privacy_Policy'])) ? $user_language[$user_selected]['lg_Privacy_Policy'] : $default_language['en']['lg_Privacy_Policy']; ?></a>
                                        &amp; <a tabindex="-1" href="<?php echo base_url();?>terms-conditions">
                                            <?php echo (!empty($user_language[$user_selected]['lg_Terms'])) ? $user_language[$user_selected]['lg_Terms'] : $default_language['en']['lg_Terms']; ?>.</a>
                                ...
                                <div class="form-group">
                                    <button id="registration_submit_user" type="submit"
                                        class="login-btn btn"><?php echo (!empty($user_language[$user_selected]['lg_Register'])) ? $user_language[$user_selected]['lg_Register'] : $default_language['en']['lg_Register']; ?></button>
                                </div>
                                <div class="account-footer text-center">
                                    <?php echo (!empty($user_language[$user_selected]['lg_already_have_account'])) ? $user_language[$user_selected]['lg_already_have_account'] : $default_language['en']['lg_already_have_account']; ?>
                                    <a href="javascript:void(0);" data-dismiss="modal" data-toggle="modal"
            ...
            <div class="modal-body step-2" data-step="2">
                ...
                <form action="<?php echo base_url()?>user/login/send_otp_request_user" method='post'
                    ...
                    <?php }?>
                    <div>
                        <button id='registration_final' type="submit"
                            class="login-btn"><?php echo (!empty($user_language[$user_selected]['lg_enter'])) ? $user_language[$user_selected]['lg_enter'] : $default_language['en']['lg_enter']; ?></button>
                    </div>
                    <div>
                        <button id='registration_resend' type="button"
                            class="invisible login-btn"><?php echo (!empty($user_language[$user_selected]['lg_Resend'])) ? $user_language[$user_selected]['lg_Resend'] : $default_language['en']['lg_Resend']; ?></button>
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body step-1" data-step="1">
                ...
                <div class="account-content">
                    <div class="account-box">
                        <div class="login-right">
                            <div class="login-header">
                                <h3><?php echo (!empty($user_language[$user_selected]['lg_forgot_password'])) ? $user_language[$user_selected]['lg_forgot_password'] : $default_language['en']['lg_forgot_password']; ?>
                                </h3>
                                <p class="text-muted">
                            ...
                            <form method='post' id="forgetpwddiv">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="userLogintype" id='user_logintype1'
                                        value="<?=$login_type?>">
                                    <input type="text" class="form-control" name="forgot_mailid" id='forgot_mailid'>
                                </div>
                                <div class="form-group">
                                    <button id="forgotpwdmail" type="submit"
                                        class="login-btn btn"><?php echo (!empty($user_language[$user_selected]['lg_Submit'])) ? $user_language[$user_selected]['lg_Submit'] : $default_language['en']['lg_Submit']; ?></button>
                                </div>
            ...
            <div class="modal-body step-2" data-step="2">
                ...
                <form action="<?php echo base_url()?>user/login/send_otp_request_user" method='post'
                    id="new_fourth_page_user1">
                    <div class="form-group">
                        <input type="hidden" class="form-control form-control-lg" placeholder="Mobile Number"
                            name='enteredMobile' id='enteredMobiles1'>
                    </div>
                    <div class="form-group">
                        <?php if(settingValue('default_otp')==0){ ?>
                        <div class="alert alert-success text-center" role="alert">
                        ...
                        <input type="text" class="form-control form-control-lg no_only" autocomplete="off" maxlength="4"
                            minlength="4"
                            placeholder="<?php echo (!empty($user_language[$user_selected]['lg_enter_otp_here'])) ? $user_language[$user_selected]['lg_enter_otp_here'] : $default_language['en']['lg_enter_otp_here']; ?>"
                            name="otp_number" id='otp_number_user1'>
                        <span for='otp_number' id='otp_error_msg'></span>
                    </div>
                    ...
                    <div>
                        <button id='registration_final1' type="submit"
                            class="login-btn"><?php echo (!empty($user_language[$user_selected]['lg_enter'])) ? $user_language[$user_selected]['lg_enter'] : $default_language['en']['lg_enter']; ?></button>
                    </div>
                    <div>
                        <button id='registration_resend1' type="button"
                            class="invisible login-btn"><?php echo (!empty($user_language[$user_selected]['lg_Resend'])) ? $user_language[$user_selected]['lg_Resend'] : $default_language['en']['lg_Resend']; ?></button>
                    </div>
                </form>
            </div>
...
<footer class="footer">
	...
	if($cat_view == 'Popular category') {
		...
		$query = $this->db->query("SELECT GROUP_CONCAT(DISTINCT(category)) as category_id, categories_lang.category_name, COUNT(*) count FROM services LEFT JOIN categories_lang on categories_lang.category_id = services.category GROUP BY category HAVING count > 0 ORDER BY count DESC LIMIT 4");
		$result = $query->result_array();
		
		 
	} 
	if($cat_view == 'Recent category(Last 7 days)') {
		$this->db->select('*');
		$this->db->from('categories');
	...
	$this->db->from('footer_submenu_lang');
    $this->db->where('lang_type', $langs);
    $this->db->where('modules', 'category_widget');
    $cat_wid_language = $this->db->get()->result_array();

    $this->db->from('footer_submenu_lang');
    $this->db->where('lang_type', $langs);
    $this->db->where('modules', 'contact_widget');
    $con_wid_language = $this->db->get()->result_array();

    $this->db->from('footer_submenu_lang');
    $this->db->where('lang_type', $langs);
    $this->db->where('modules', 'social_widget');
    $soc_wid_language = $this->db->get()->result_array();
	?>
    <!-- Footer Top -->
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="about">
                            <div class="contactdet">
                                <ul>
                                    ...
                                    <li><a
                                            href="<?php echo $base_url; ?>pages_details/<?php echo $quick['slug']; ?>"><?php echo $quick['title']; ?></a>
                                    </li>
                                    <?php }?>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget footer-menu">
                        <?php 
			                        foreach ($con_wid_language as $con_wid) { ?>
                        <h2 class="footer-title">
                            <?php echo(!empty($con_wid['title']))?($con_wid['title']) : 'Contact Widget';  ?></h2>
                                ...
                                <ul>
                                    <li class="color-grey">
                                        <div class="footer-contact-info">
                                            ...
                                            <p><i class="fas fa-headphones"></i> <?php echo $contact_us->phone; ?></p>
                                            <p class="mb-0"><i class="fas fa-envelope"></i>
                                                <?php echo $contact_us->email; ?></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget footer-menu">
                        <?php 
			                        foreach ($soc_wid_language as $soc_wid) { ?>
                        <h2 class="footer-title">
                            <?php echo(!empty($soc_wid['title']))?($soc_wid['title']) : 'Contact Widget';  ?></h2>
    ...
    <div id="my_map" class="modal fade map-modal" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo (!empty($user_language[$user_selected]['lg_drag_point'])) ? $user_language[$user_selected]['lg_drag_point'] : $default_language['en']['lg_drag_point']; ?>
                    </p>
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6"><input type="hidden" id="user_latitude"
                                        value="<?php echo $this->session->userdata('latitude');?>" class="form-control">
                                </div>
                        ...
                        <div class="col-md-4">
                            <button onclick="setlocation()"
                                class="setlocation btn btn-primary"><?php echo (!empty($user_language[$user_selected]['lg_set_location'])) ? $user_language[$user_selected]['lg_set_location'] : $default_language['en']['lg_set_location']; ?></button>
                            <button onclick="clearlocation()"
                                class="setlocation btn btn-danger"><?php echo (!empty($user_language[$user_selected]['lg_clear_location'])) ? $user_language[$user_selected]['lg_clear_location'] : $default_language['en']['lg_clear_location']; ?></button>
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <h5 class="mb-3">
                        ...
                        : <span id="slider_value"><?php echo $this->session->userdata('distance');?></span></h5>
                    <div id="map"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                        data-dismiss="modal"><?php echo (!empty($user_language[$user_selected]['lg_close'])) ? $user_language[$user_selected]['lg_close'] : $default_language['en']['lg_close']; ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="login-right">
                                <div class="login-header">
                                    <?php 
											    ...
											    $lang_website_check = $this->db->get('cookies')->row_array();
											 ?>
                                    <h3><?php echo (!empty($user_language[$user_selected]['lg_login'])) ? $user_language[$user_selected]['lg_login'] : $default_language['en']['lg_login']; ?>
                                    </h3>
                                    <p class="text-muted">
                                        ...
                                        <?=$lang_website_check['cookie_name']?></p>
                                </div>
                                <div class="form-group">
                                    <label><?php echo (!empty($user_language[$user_selected]['lg_email'])) ? $user_language[$user_selected]['lg_email'] : $default_language['en']['lg_email']; ?></label>
                                    <div class="row">
                                ...
                                <button class="login-btn" id="emaillogin_submit"
                                    type="submit"><?php echo (!empty($user_language[$user_selected]['lg_login'])) ? $user_language[$user_selected]['lg_login'] : $default_language['en']['lg_login']; ?></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-2" data-step="2" id="otp_final_div">
                    <div class="login-header">
                        <h3><?php echo (!empty($user_language[$user_selected]['lg_password'])) ? $user_language[$user_selected]['lg_password'] : $default_language['en']['lg_password']; ?>
                        </h3>
                        <p class="text-muted">
                            <?php echo (!empty($user_language[$user_selected]['lg_verify_your_account'])) ? $user_language[$user_selected]['lg_verify_your_account'] : $default_language['en']['lg_verify_your_account']; ?>
                        </p>
                    ...
                    <p class="user_forgot_pwd">Forgot Password ? <a href="#" id="user_forgot_pwd">
                            <?php echo (!empty($user_language[$user_selected]['lg_click_get_link'])) ? $user_language[$user_selected]['lg_click_get_link'] : $default_language['en']['lg_click_get_link']; ?></a>
                    </p>
                    <span id="err_respwd"></span>
                    <div>
                        <button id='emailregistration_finals' type="button"
                            class="login-btn"><?php echo (!empty($user_language[$user_selected]['lg_enter'])) ? $user_language[$user_selected]['lg_enter'] : $default_language['en']['lg_enter']; ?></button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="account-content">
                        <div class="account-box">
                            <div class="login-right">
                                ...
                                <button class="login-btn" id="login_submit"
                                    type="submit"><?php echo (!empty($user_language[$user_selected]['lg_login'])) ? $user_language[$user_selected]['lg_login'] : $default_language['en']['lg_login']; ?></button><br>
                                ...
                                <div class="account-footer-link">
                                    <a href="javascript:void(0);" data-dismiss="modal" data-toggle="modal"
                                        data-target="#modal-wizard"><?php echo (!empty($user_language[$user_selected]['lg_Join_Professional'])) ? $user_language[$user_selected]['lg_Join_Professional'] : $default_language['en']['lg_Join_Professional']; ?></a>
                                    <a href="javascript:void(0);" data-dismiss="modal" data-toggle="modal"
                                        data-target="#modal-wizard1"><?php echo (!empty($user_language[$user_selected]['lg_join_as_user'])) ? $user_language[$user_selected]['lg_join_as_user'] : $default_language['en']['lg_join_as_user']; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="step-2" data-step="2" id="otp_final_div">
                    ...
                    <?php }?>
                    <div>
                        <button id='registration_finals' type="button"
                            class="login-btn"><?php echo (!empty($user_language[$user_selected]['lg_enter'])) ? $user_language[$user_selected]['lg_enter'] : $default_language['en']['lg_enter']; ?></button>
                    </div>
                </div>
            </div>
...
<input type="hidden" id="site_name" value="<?php echo $lang_website_check['cookie_name'];?>">
...
<?php 
            ...
            $this->db->where('lang_type', $user_lang);
            $cookie = $this->db->get('cookies')->row_array();
		?>
<input type="hidden" id="cookies_content_text" value="<?php echo $cookie['cookie_name']; ?>">
...
<?php }?>
<?php if($this->uri->segment(1)=="provider-settings" || $this->uri->segment(1)=="add-service" || $this->uri->segment(3)=="edit_service"){ ?>
