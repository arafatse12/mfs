<div class="col-xl-3 col-md-4">
				...
				<div class="widget settings-menu">
					<ul role="tablist" class="nav nav-tabs">	
						...
						<li class="nav-item current">
							<a href="<?php echo base_url()?>user-favorites" class="nav-link <?= ($this->uri->segment(1)=="user-favorites")?'active':'';?>">
								<i class="fas fa-heart"></i>
								<span><?php echo (!empty($user_language[$user_selected]['lg_favorites_list'])) ? $user_language[$user_selected]['lg_favorites_list'] : $default_language['en']['lg_favorites_list']; ?></span>
							</a>
						</li>					
						<li class="nav-item">
