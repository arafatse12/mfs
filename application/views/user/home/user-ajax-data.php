                        ...
                        <div class="booking-det-info">
                            ...
                            <ul class="booking-details">
                                ...
                                <li>
                                    ...
                                    <?php if($bookings['cod'] == 1) { ?><span class="badge badge-pill badge-prof">COD</span> <?php } ?>
                                </li>
                                <li>
                                     <?php  
                    ...
                    <div class="booking-action">
                        ...
                        <?php } elseif ($bookings['status'] == 3) { ?>
                            ...
                            <a href="javascript:;" class="btn btn-sm bg-success-light update_user_booking_status" data-id="<?= $bookings['id']; ?>" data-status="6" data-rowid="<?= $pending; ?>" data-review="2" >
                                <i class="fas fa-check"></i> Complete Request Accept
                            </a>
                        ...
                        <?php  
                            ...
                            if ($bookings['status'] != 10 && $bookings['status'] != 9 && $bookings['cod'] == 1 && $bookings['status'] == 8) {
                        ?>
                        ...
                        <?php } elseif($bookings['status'] != 10 && $bookings['status'] != 9 && $bookings['cod'] == 2) { ?>
                        ...
                        <?php if ($bookings['status'] == 6 || ($bookings['status'] == 8)) { 
                                $rating_count = $this->db->where('user_id', $this->session->userdata('id'))->where('booking_id', $bookings['id'])->get('rating_review')->result_array();
