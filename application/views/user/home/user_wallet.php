        ...
        <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <?php } if(settingValue('midtrans_show') == 1) { ?>
                                        <div class="col-4">
                                    ...
                                    <?php } ?>
                                    <?php /* if(settingValue('2checkout_show') == 1) { ?>
                                        <div class="col-4">
                                            <input class="form-check-input" type="radio" name="payment_type" id="2checkout"  value="2checkout">
                                            <img src="<?php echo base_url() . "assets/img/2checkout.png"; ?>">
                                        </div> -->
                                    <?php } */ ?>
                                    </div>
                                    <br>
                                ...
                                <?php    $query = $this->db->query("select * from system_settings WHERE status = 1");
                                    ...
                                    $midtrans_option = settingValue('midtrans_show');
                                    ...
                                    if ($midtrans_option == 1) {
                                        $midtrans_key = settingValue('midtrans_apikey');
                                    }
                                    ...
                                    <input type="hidden" id="midtrans_key" value="<?php echo $midtrans_key; ?>">
            ...
            <form action="<?php echo base_url()?>vtweb/vtweb_checkout"  method="POST" id="midtrans_form">
                ...
                <input type="hidden" id="city" value="<?php echo (!empty($city)) ? $city : "Chicago"; ?>">
                 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                 <input type="hidden" name="productdetail" id="productdetail" value="wallet">
                 <input type="hidden" name="refno" value="<?=uniqid()?>">
            </form>
