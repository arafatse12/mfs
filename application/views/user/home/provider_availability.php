...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
          ...
          <div class="row">
            ...
            $var_to_time[7] = $Sunday_to_time;
              ...
              <?php
              if(isset($availability_details[0]['day']) && $availability_details[0]['day']==1){
 ...
 $mon_to_time=$availability_details[0]['to_time'];
            ...
            <?php
              ...
              if(isset($availability_details[0]['day']) && $availability_details[0]['day']==2){
                $tues_check='checked';
                $tue_from_time=$availability_details[0]['from_time'];
                $tue_to_time=$availability_details[0]['to_time'];
              }elseif(isset($availability_details[1]['day']) && $availability_details[1]['day']==2){
                $tues_check='checked';
            ...
            <?php
              ...
              if(isset($availability_details[0]['day']) && $availability_details[0]['day']==3){
                $wed_check='checked';
                $wed_from_time=$availability_details[0]['from_time'];
                $wed_to_time=$availability_details[0]['to_time'];
              }elseif(isset($availability_details[1]['day']) && $availability_details[1]['day']==3){
                $wed_check='checked';
                $wed_from_time=$availability_details[1]['from_time'];
                $wed_to_time=$availability_details[1]['to_time'];
              }elseif(isset($availability_details[2]['day']) && $availability_details[2]['day']==3){
                $wed_check='checked';
            ...
            $mytotime = explode(':',$my_to_time);
            $my_to_time = sprintf("%02d", $mytotime[0]).':'.$mytotime[1];
