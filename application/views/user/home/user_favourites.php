                        ...
                        <tbody>
                            ...
                            if (!empty($all_favorites)) { 
                                ...
                                foreach ($all_favorites as $favorites) { 
                                    ...
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo '<a href="#" class="avatar avatar-sm mr-2"> <img class="avatar-img rounded-circle" alt="" src="'.$provider_img.'"></a>'.str_replace('-', ' ', $lang_pro['name']); ?></td>
                                        <td><?php echo '<a href="#" class="avatar avatar-sm mr-2"> <img class="img-fluid serv-img" alt="" src="'.$service_img.'"></a>'.$service_name['service_name']; ?></td>
                                        <td><?php echo '<a href="#" class="avatar avatar-sm mr-2"> <img class="img-fluid serv-img" alt="" src="'.$category_img.'"></a>'.$cat_name['category_name']; ?></td>
                                        <td><?php echo '<a href="#" class="avatar avatar-sm mr-2"> <img class="img-fluid serv-img" alt="" src="'.$sub_category_img.'"></a>'.$subcat_name['subcategory_name']; ?></td>
                                        <td><?php echo "<a target='_blank' href='".$base_url."service-preview/".$favorites['url'] ."' alt='view' class='mr-2'><i class='far fa-eye mr-1'></i><span> ".$view."</span></a>"; ?></td>
                                    </tr>
                                <?php $i++; } //foreach end
                            } //if empty end
                            else{ ?>
