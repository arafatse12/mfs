                            ...
                            <div class="card-body">
								...
								<form action="<?= base_url() ?>user/wallet/payment" method="post" id="paypal_payment">
									<div class="form-group">
                                        ...
                                        <?php } if(settingValue('paysolution_show') == 1) { ?>
                                                <div class="col-4">
                                                    <span>
                                                        <input class="form-check-input" id="gigs_payment_radio7" type="radio" name="group2" id="paysolution"  value="paysolution">
                                        ...
                                        <?php }  if(settingValue('midtrans_show') == 1) { ?>
                                                <div class="col-4">
                                                    <span>
                                                        <input class="form-check-input" id="gigs_payment_radio7"  type="radio" name="group2" id="midtrans"  value="midtrans">
                                       ...
                                       <?php }  
                                       /* if(settingValue('iyzico_show') == 1) { ?>
                                                <div class="col-4">
                                                    <span>
                                                        <input class="form-check-input" id="gigs_payment_radio7"  type="radio" name="group2" id="iyzico"  value="iyzico">
                                ...
                                <?php
                                   ...
                                   <input type="hidden" id="paypal_key" value="<?= $paypall_key; ?>">
                                    ...
                                    <input type="hidden" id="iyzico_key" value="<?= $iyzico_key; ?>"> 
                             ...
                             ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($wallet_history)) {
                                            foreach ($wallet_history as $key => $value) {
                                                //echo 'ss<pre>'; print_r($value); exit;
