...
class Wallet extends CI_Controller {
 ...
 //
  public function getProivdierBankDetails() {
    ...
    $bank_details = $this->db->select('account_holder_name,acc_no as account_number,account_iban,bank_name,bank_addr as bank_address,sort_code,routing_number,ifsc_code as account_ifsc')->get_where('bank_account', array('user_id'=>$provider_id))->row();
