...
$sql =  "SELECT *  FROM `system_settings`  WHERE  (`key` = 'time_zone')";
...
defined('BASEPATH') OR exit('No direct script access allowed');
    $var = explode(' ',$timezone);
    
date_default_timezone_set($var[1]);
...
if (isset($_SERVER["REQUEST_URI"])) 
{
	...
	elseif(stripos($_SERVER["REQUEST_URI"],'/api')  !==false)
    {
        $config['csrf_protection'] = FALSE;
		$cf=2;
    } elseif(stripos($_SERVER["REQUEST_URI"],'/paysolution')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
    }
    elseif(stripos($_SERVER["REQUEST_URI"],'/vtweb')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
    }  elseif(stripos($_SERVER["REQUEST_URI"],'/flutterwave-payment-post')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
    } elseif(stripos($_SERVER["REQUEST_URI"],'/iyzico-payment')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
    } elseif(stripos($_SERVER["REQUEST_URI"],'/user/dashboard/iyzico_payment')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
    } elseif(stripos($_SERVER["REQUEST_URI"],'/user/dashboard/iyzico_withdraw')  !==false) {
        $config['csrf_protection'] = FALSE;
        $cf=2;
