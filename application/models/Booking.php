...
class Booking extends CI_Model{ 
    ...
    function getRows($params = array()){ 
      $this->db->select("b.*,s.service_title,s.service_image,s.service_amount,s.rating,s.service_image,c.category_name,sc.subcategory_name,p.profile_img,p.mobileno,p.country_code,s.url");
