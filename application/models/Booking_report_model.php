...
class Booking_report_model extends CI_Model
{
    ...
    {
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status, tab_1.cod, tab_1.reject_paid_token, tab_1.admin_reject_comment, tab_1.admin_update_status');
        $this->db->select('tab_2.id as serviceid, tab_2.service_title');
        $this->db->select('tab_3.id as userid, tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
        $this->db->select('tab_4.id as providerid, tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
...
/*booking reports*/
    ...
    public function get_pending_bookings()
    {
        ...
        $this->db->select('tab_2.service_title,tab_2.id as serviceid');
    ...
    public function get_filter_pending_bookings($service_id,$status,$user_id,$provider_id,$from,$to)
    {
        ...
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status,tab_1.service_id as serviceid');
    ...
    {
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status,tab_1.cod');
        $this->db->select('tab_2.service_title,tab_2.id as serviceid');
        $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
        $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
        $this->db->from('book_service tab_1');
        ...
        $this->db->or_where('tab_1.status',8);
        $this->db->order_by('tab_1.id','DESC');
        $returns=$this->db->get()->result_array();
        return $returns;
    }
    ...
    {
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,,tab_1.admin_change_status,tab_1.reject_paid_token,tab_1.admin_reject_comment,tab_1.admin_change_status,tab_1.cod, tab_1.admin_update_status');
        $this->db->select('tab_2.service_title,tab_2.id as serviceid');
        $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
        $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
        $this->db->from('book_service tab_1');
    ...
    {
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status,tab_1.reject_paid_token,tab_1.admin_reject_comment,tab_1.cod, tab_1.admin_update_status');
        $this->db->select('tab_2.service_title,tab_2.id as serviceid');
        $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
        $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
        $this->db->from('book_service tab_1');
    ...
    public function get_filter_cancel_bookings($service_id,$status,$user_id,$provider_id,$from,$to)
    {
        ...
        $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status,tab_1.cod, tab_1.admin_update_status');
        $this->db->select('tab_2.service_title');
        $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
        $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
        $this->db->from('book_service tab_1');
  ...
  if(!empty($data['book_id'])){
     $booking=$this->get_book_info($data['book_id']);
          ...
          if(!empty($booking)){
                        ...
                        if($booking['status'] == 7) {
                            $cash_text="Cancelled by Provider and refunded by Admin.";
